 ...
 * [bzk.yml](bzk.yml)
     * Determines how your purl.obolibrary.org/obo/bzk/ redirects will be handled
     ...
     * Paste in the contents of [bzk.yml](bzk.yml)
 ...
 * [bzk.md](bzk.md)
     ...
     * Paste in the contents of [bzk.md](bzk.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
